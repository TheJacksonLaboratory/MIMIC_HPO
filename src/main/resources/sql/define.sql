-- This is a subset of the sql commands to import mimic tables into MySql. We only import the tables that are of interest to us.
-- Aaron Zhang
-- full command refer to: https://github.com/MIT-LCP/mimic-code/blob/master/buildmimic/mysql/1-define.sql
